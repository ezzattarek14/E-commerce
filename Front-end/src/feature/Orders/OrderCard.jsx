...
function OrderCard({ index, order }) {
  ...
  return (
    <div className="text-start flex-col h-full gap-5 p-0 justify-between relative">
      ...
      <div className="w-full bg-black text-white flex transition-all duration-300 justify-center rounded-bl-xl py-2 cursor-pointer rounded-br-xl hover:text-black hover:bg-white p-0 font-bold text-xl">
